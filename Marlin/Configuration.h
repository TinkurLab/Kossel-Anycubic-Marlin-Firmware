...
// Heated Bed:
// 0 ... no heated bedSTRING_CONFIG_H_AUTHOR
...
#define HEATER_0_MAXTEMP 260 //Adam
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #define DEFAULT_Kp 29.74
  #define DEFAULT_Ki 1.96
  #define DEFAULT_Kd 112.68
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // from pid autotune. "M303 E-1 C8 S60" to run autotune on the bed at 60 degreesC for 8 cycles
    ...
    #define DEFAULT_bedKp 191.20
    #define DEFAULT_bedKi 34.84
    #define DEFAULT_bedKd 699.59
...
#define DELTA
  ...
  //#define DELTA_HOME_TO_SAFE_ZONE //Adam commented this out to help w/ leveling G29 commands
  ...
  // NOTE NB all values for DELTA_* values MUST be floating point, so always have a decimal point in them
    ...
    // Horizontal distance bridged by diagonal push rods when effector is centered.
    #define DELTA_RADIUS 131.38             // (mm) Get this value from G33 auto calibrate Adam
  #endif

  // Distance between bed and nozzle Z home position
  #define DELTA_HEIGHT 280.77             // (mm) Get this value from G33 auto calibrate Adam

  #define DELTA_ENDSTOP_ADJ { 0.00, -0.43, -0.76 } // Get these values from G33 auto calibrate Adam
 

  // Trim adjustments for individual towers
  // tower angle corrections for X and Y tower / rotate XYZ so Z tower angle = 0
  // measured in degrees anticlockwise looking from above the printer
  #define DELTA_TOWER_ANGLE_TRIM { -0.43, 0.49, -0.06 } // Get these values from G33 auto calibrate Adam
 ...
 */
  ...
  #define NOZZLE_TO_PROBE_OFFSET { 0, 0, -15.1 } //Adam
...
#define MIN_PROBE_EDGE 50 //Adam custom for raised screws
